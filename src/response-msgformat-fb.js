...
module.exports.responseFormat = (msg, datafetch) => {
  ...
  function productscarousel() {
    ...
    for (let i = 0; i < l; i++) {
      ...
      items.default_action.url = "https://barista-shop3.myshopify.com/products/" + msg[i].productURL;
      items.buttons[0].url = 'https://barista-shop3.myshopify.com/products/' + msg[i].productURL;
        ...
        "buttons": [
          {
            ...
            "fallback_url": "https://barista-shop3.myshopify.com/"
          }
        ],
        "default_action": {
          "type": "web_url",
