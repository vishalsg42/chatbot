...
module.exports.responseFormat = (msg, datafetch) => {
  ...
  function productscarousel() {
    ...
    for (let i = 0; i < l; i++) {
      ...
      items.default_action.url = "https://barista-shop2.myshopify.com/products/" + msg[i].productURL;
      items.buttons[0].url = 'https://barista-shop2.myshopify.com/products/' + msg[i].productURL;
  ...
  function productscard() {
    ...
    for (let i = 0; i < 4; i++) {
        ...
        "buttons": [
          {
            ...
            "fallback_url": "https://barista-2.myshopify.com/"
          }
        ],
        "default_action": {
          "type": "web_url",
      ...
      items.subtitle = msg[i].subtitle;
      items.image_url = msg[i].img;
      items.default_action.url = "https://barista-2.myshopify.com/products/" + msg[i].productURL;
      items.buttons[0].url = 'https://barista-shop2.myshopify.com/products/' + msg[i].productURL;
